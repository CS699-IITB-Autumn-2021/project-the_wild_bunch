...
def main():
	...
	parser.add_argument("-w","--pretty_print_html_file",metavar="", required=False, help="File name to dump the html generated file")
	parser.add_argument("-s","--pretty_print_html",metavar="", required=False, help="Dump the html generated on stdout")
	...
	if args.pretty_print_html_file:
		#print all the data in html format
		article_obj.html_print(args.pretty_print_html_file)	
	
	if args.pretty_print_html:
		#print data on stdout
		article_obj.store_imgs_and_print(num)
