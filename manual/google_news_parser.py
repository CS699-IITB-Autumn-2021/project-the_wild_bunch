...
def main():
	...
	parser.add_argument("-n","--fetch_result",metavar="", required=False, help="Maximum number of results. Option to be given only with author. To restrict the number of results to upload on sql.")
